...
router.get('/education', function (req, res) {
  ...
  res.render('education', {
    ...
    main: {
      ...
      certificates: [
        {
          name: 'Сертивікат про закінчення Школи',
          id: 12314,
        },
        {
          name: 'Сертивікат про закінчення Ліцею',
          id: 12314,
        },
        {
          name: 'Сертивікат про закінчення Коледжу',
          id: 12314,
        },
      ],
    },
      ...
      works: [
        {
          ...
          projects: [
            {
              name: 'Resume',
              url: 'https://www.resonatehq.com/inbound-blog/international-awards-for-it-companies',
              about:
              ...
              awards: [
                {
                  name: 'DataCloud Global Awards. Более 20 различных номинаций, связанных с cloud решениями и дата-центрами.',
                },
                {
                  name: 'IoTGA - Internet of Things Global Awards',
                },
              ],
            },
          ],
            ...
            details: {
              museum: {
                ...
                exhibits: [
                  ...
                  {
                    name1: 'Winged Victory of Samothrace',
                    artist1: null,
                    description1:
